...
**Last Updated**: February 2025 (Simplified Work Experience Wizards Implementation)
...
- `NewAIWizardModal.test.tsx`: 19 failing tests due to removed UI elements
- Tests are looking for removed elements like "Generated by AI" badge, "+ Strength" labels
- Failures are **expected** and validate that UI simplifications worked correctly

### **Context**
During wizard UI simplification, we intentionally removed:
- "Generated by AI" labels from AI preview sections
- "+ Strength" badges from impact input fields  
- Various helper text and redundant UI elements

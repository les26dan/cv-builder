        ...
        <div className="flex items-center gap-2">
          ...
          {id === 'experience' && onAddItem && (experienceCount || 0) > 1 && (
            <button
              ...
              className="px-4 py-2 border border-primary-500 text-primary-500 bg-white text-sm font-medium rounded-lg hover:bg-primary-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"

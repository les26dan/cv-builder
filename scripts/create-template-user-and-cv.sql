-- Create a template/demo user and associate the template CV with it
-- This allows the template CV to exist in the database

BEGIN;

-- Step 1: Create a template user (if not exists)
...
SELECT id, title, status, source, user_id FROM cv_workflow WHERE id = 'template-1770903803894';

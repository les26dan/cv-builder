...
\usepackage[top=4cm, bottom=3cm, left=3cm, right=2cm]{geometry}
\usepackage{xurl}
\usepackage{appendix}
\usepackage{babel}
...
\usepackage{graphicx}
\usepackage{tikz}
\usetikzlibrary{calc,positioning,shapes.geometric,shapes.symbols,arrows.meta,fit,backgrounds}
\usepackage{fancybox}
% \usepackage{indentfirst}  % disabled — đoạn đầu sau heading không thụt
\usepackage{amsthm}
\usepackage{latexsym}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsbsy}
% \usepackage{times}  % disabled — VNTeX CMR gives nicer Vietnamese diacritics
\usepackage{array}

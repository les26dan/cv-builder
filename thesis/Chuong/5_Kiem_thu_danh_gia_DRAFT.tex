...
% =============================================================================
% CHƯƠNG 5 — DRAFT MỚI (đóng góp khoá luận: so sánh 3 phương pháp matching CV-JD)
% Bản này thay thế hoặc bổ sung cho 5_Kiem_thu_danh_gia.tex hiện có
% Số liệu trong các bảng/hình là PLACEHOLDER, sẽ điền khi chạy xong evaluation
% =============================================================================
...
\begin{itemize}
    \item \textit{Resume Dataset} (\textasciitilde 2,400 CV, 24 nhóm nghề): cột \texttt{Category}, \texttt{Resume\_str}.
    \item \textit{Job Postings} (\textasciitilde 500K JD, đã sample còn 21 MB): cột \texttt{Job Title}, \texttt{Job Description}.
\end{itemize}
...
TF-IDF       & \textit{[•]} & \textit{[•]} & \textit{[•]} & \textit{[•]} & \textit{[•]} \\ \hline
Embeddings   & \textit{[•]} & \textit{[•]} & \textit{[•]} & \textit{[•]} & \textit{[•]} \\ \hline
LLM (gpt-4o-mini) & \textit{[•]} & \textit{[•]} & \textit{[•]} & \textit{[•]} & \textit{[•]} \\ \hline
\end{tabular}
\end{table}
...
TF-IDF vs Embeddings & \textit{[•]} & \textit{[•]} & \textit{[•]} \\ \hline
TF-IDF vs LLM        & \textit{[•]} & \textit{[•]} & \textit{[•]} \\ \hline
Embeddings vs LLM    & \textit{[•]} & \textit{[•]} & \textit{[•]} \\ \hline
\end{tabular}
\end{table}
...
TF-IDF       & \textit{[•]} & \textit{[•]} & 0.00 \\ \hline
Embeddings   & \textit{[•]} & \textit{[•]} & \textit{[\textasciitilde 0.02]} \\ \hline
LLM          & \textit{[•]} & \textit{[•]} & \textit{[\textasciitilde 2.00]} \\ \hline
\end{tabular}
\end{table}

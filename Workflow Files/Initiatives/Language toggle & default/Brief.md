...
- Landing Page (all texts, buttons)
   ...
   - CV Workspace (all texts, buttons)
   - CV Upload (all texts, buttons, critical: JD Parser with language detection for its logic to work accurately)
   - CV Guided Editing (most critical & sotisphicated)
   - CV Workflow Integration

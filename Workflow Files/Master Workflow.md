...
- Review our existing codebase at `/Users/tomnguyen/Documents/Cursor/Projects/CV Builder`, carefully analyze the existing components, features, and user flows implemented in their respective codebases, to gain full understanding of the system logic, architecture, and UX patterns:
   - Landing Page
...
- With all context reviewed, start or continue implementation of the initiative:
   - Use the Product Spec at: `/Users/tomnguyen/Documents/Cursor/Projects/CV Builder/Projects/CV Workflow/cv-suggestions-ai/JD–CV Optimization and Apply All.md`[//]
      ...
      - Use the provided UI designs to guide layout, styling, and user interactions.  
   - Refer to the attached UI for reference. [//]
   - Begin with the first task listed under the REMAINING TASKS section at: `'/Users/tomnguyen/Documents/Cursor/Projects/CV Builder/Projects/CV Workflow/Projects Working Directory/chatgpt-ai-integration/tasks.md'` [//]

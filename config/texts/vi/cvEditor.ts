export const cvEditor = {
  ...
  sections: {
    ...
    skills: {
      ...
      placeholder: 'Thêm kỹ năng... (ví dụ: Python, Kỹ năng quản lý thời gian, Adobe Photoshop) - Phân tách nhiều kỹ năng bằng dấu phẩy',
      ...
      aiSuccess: {
        multiple: 'Kỹ năng được chọn lọc chuyên nghiệp để tăng cường hồ sơ dựa trên kinh nghiệm và vị trí mục tiêu của bạn. Xem xét và thêm những kỹ năng tôn lên giá trị của bạn.',
        single: 'Kỹ năng được chọn lọc chuyên nghiệp để nâng cao hồ sơ dựa trên kinh nghiệm và vị trí mục tiêu của bạn. Thêm vào để thể hiện thế mạnh của bạn.',
      },
      confirmations: {
  ...
  preview: {
    ...
    actions: {
      download: 'Tải về',
      previewPDF: 'Xem CV định dạng PDF',
      print: 'In',
      share: 'Chia sẻ',
    },

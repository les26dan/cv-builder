...
export const viSkillsAIPrompts = {
  enhancedSkillSuggestions: {
    ...
    user: "Dựa vào kinh nghiệm làm việc chi tiết dưới đây, đề xuất từ 6 đến 8 kỹ năng phù hợp nhất để bổ sung và nâng cao chuyên môn đã được chứng minh:\n\nKỹ năng hiện tại: {skills}\n\nKINH NGHIỆM LÀM VIỆC CHI TIẾT (phân tích kỹ từng vai trò):\n{workExperience}\n\nVị trí mục tiêu: {jobTitle}\n\nMô tả công việc mục tiêu: {targetJob}\n\nYêu cầu đề xuất kỹ năng:\n1. PHÂN TÍCH kỹ lưỡng từng vai trò trong kinh nghiệm làm việc - trích xuất các năng lực cốt lõi được thể hiện qua chức danh, trách nhiệm và thành tựu cụ thể.\n2. Đề xuất 6–8 kỹ năng bổ trợ trực tiếp và xây dựng dựa trên kinh nghiệm CỤ THỂ đã có (không phải kỹ năng chung chung).\n3. Tập trung vào những kỹ năng mà logic sẽ cần thiết hoặc được phát triển trong các vai trò đã mô tả trong kinh nghiệm.\n4. Ưu tiên các kỹ năng giúp thu hẹp khoảng cách giữa kinh nghiệm hiện tại và vị trí công việc mục tiêu.\n5. Không lặp lại bất kỳ kỹ năng nào đã được liệt kê ở phần 'Kỹ năng hiện tại'.\n6. Cân bằng giữa kỹ năng kỹ thuật/chuyên môn (công cụ, phương pháp, chứng chỉ) và kỹ năng mềm (lãnh đạo, giao tiếp, tư duy chiến lược).\n7. Đảm bảo các đề xuất phù hợp với người có nền tảng kinh nghiệm làm việc cụ thể này.\n8. Sử dụng thuật ngữ chuyên nghiệp phù hợp với tiêu chuẩn ngành cho trình độ kinh nghiệm đã chứng minh.\n9. Chỉ trả về danh sách tên kỹ năng sạch (6–8 kỹ năng), mỗi kỹ năng viết trên một dòng riêng biệt.\n10. KHÔNG sử dụng số thứ tự (1., 2., 3.), KHÔNG sử dụng tiền tố 'Kỹ năng', KHÔNG sử dụng dấu gạch đầu dòng (-, •).\n11. Chỉ viết tên kỹ năng thuần túy bằng TIẾNG VIỆT, ví dụ: 'Lãnh đạo nhóm', 'Excel nâng cao', 'Lập kế hoạch chiến lược'.\n12. QUAN TRỌNG: Chỉ trả về danh sách kỹ năng thuần túy, KHÔNG có tiêu đề, KHÔNG có phần giải thích - chỉ những kỹ năng bổ trợ hợp lý cho kinh nghiệm làm việc đã được chứng minh của người này."
  },

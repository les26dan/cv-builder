export const workExperienceWizardTexts = {
  ...
  newWizard: {
    ...
    aiPreview: {
      title: 'AI will create content like this:',
      subtitle: 'Based on the position and company you entered',
      generatedBy: 'Generated by AI'
    },
    jobTitleSuggestions: ['Software Engineer', 'Marketing Manager', 'Sales Executive'],
    tips: {
      shortInput: 'Tip: Just enter 3-5 words for each item and let AI complete the rest!',
    ...
    fields: {
      ...
      company: {
        ...
        placeholder: 'e.g: Google, Vingroup, FPT Software'
      },
      project: {
      ...
      impact: {
        ...
        placeholder: 'e.g: Increased revenue 30%, Reduced costs...',
        badge: '+ Strength'
      }
    }
  },
